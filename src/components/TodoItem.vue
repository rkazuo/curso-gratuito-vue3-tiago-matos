...
mr-2">
                <button @click="toogleCompleted" :class="{ 'text-green-600': !isCompleted, 'text-gray-600': isCompleted }">
            ...
            <div class="w-full">
                <input @keyup.enter="updateTitle" type="text" placeholder="Digite a sua tarefa" :value="todo.title"
                    class="bg-gray-300 
placeholder-gray-500 text-gray-700 font-light focus:outline-none block 
w-full appearance-none leading-normal mr-3" :class="{ 'line-through': isCompleted }">
            </div>
...
export default {
    ...
    setup(props) {
        ...
        return {
            title, isCompleted,
            deleteTodo, updateTodo, updateTitle, toogleCompleted
        }
    },
